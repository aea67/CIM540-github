//Mouse Press and Release Function Homework
var mouthX = 25;
var mouthY = 350;
var mouthW = 400;
var mouthH = 60;
...
//var backgroundColor = background(255, 255, 179);
var randNum = 0;
var mapX = 0;
...
function draw() {
    frameRate(40);
    background(backgroundColor); //light yellow. //gets redrawn.
    fill(0);
