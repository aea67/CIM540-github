var choices = {
    "Cake": 0, //set at 0, no choices have been made
    "Candy": 0,
    "Pie": 0,
    "Savory": 0
};
...
function draw() {
    ...
    fill(255, 0, 0, 100);
    ellipse(40, height / 2 + 25, choices["Cake"], choices["Cake"]);
    fill(0, 255, 0, 100);
//circle will change shape depending on how many points it gets.
    ellipse(100, height / 2 + 25, choices["Candy"], choices["Candy"]);
    fill(0, 0, 255, 100);

    ellipse(180, height / 2 + 25, choices["Pie"], choices["Pie"]);
    fill(100, 100, 100);
    ellipse(260, height / 2 + 25, choices["Savory"], choices["Savory"]);

    fill(0, 0, 0);

    text(cakeMessage, 10, height / 2); //displays text in screen
